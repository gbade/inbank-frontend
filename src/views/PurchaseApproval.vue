...
const validateForm = (): boolean => {
  if (!form.personalId || form.personalId.trim() === "") {
  ...
  errors.requestedAmount =
    !amount || amount < 100 || amount > 10000
      ? "Amount must be between 100 and 10000"
      : "";

  const period = Number(form.paymentPeriod);
  errors.paymentPeriod =
    !period || period < 12 || period > 60
      ? "Payment period must be between 12 and 60 months"
      : "";
