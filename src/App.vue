...
<div class="container mx-auto p-4 max-w-[560px]">
    <h1 class="text-3xl font-bold text-center mb-8">Purchase Approval System</h1>
    <PurchaseApproval 
    :loading="loading"
    @submit="handleSubmit" 
    />
...
try {
    ...
    loading.value = false;
    error.value = (err as AxiosError<{ message: string }>)?.response?.data?.message || 'An unexpected error occurred';
